...
- [ ] **Directory Setup**: Initialize standard folders: `src/components`, `src/lib`, `src/types`, `src/hooks`, `src/services`, `src/styles`.
- [ ] **Structure Documentation**: Create `docs/NEXTJS_STRUCTURE.md` explaining the purpose of each directory, naming conventions, and the App Router architecture.
