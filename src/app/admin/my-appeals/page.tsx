    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 mb-2">My Ministry Appeals</h1>
                    <p className="text-gray-500">Track the status of your personal fundraising requests.</p>
                </div>
                <Link 
                    href="/donate" 
