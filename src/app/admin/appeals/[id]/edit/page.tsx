...
export default function EditAppealPage() {
    ...
    if (loading) return <div className="p-10 text-center">Loading appeal details...</div>;
        ...
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex-1">
                     <h1 className="text-2xl font-bold text-gray-900">Edit Appeal</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <select 
                            ...
                            onChange={handleChange}
                            className={`w-full px-4 py-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 font-bold ${
