...
export default function AppealDetailPage() {
    ...
    return (
        <div className="pb-8 max-w-4xl mx-auto">
            <div className="mb-6">
                <Link href="/admin/appeals" className="text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 font-medium inline-flex items-center gap-2 transition-colors">
