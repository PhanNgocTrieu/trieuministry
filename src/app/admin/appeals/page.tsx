        ...
        <AdminGuard>
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Manage Appeals</h1>
                        <p className="text-slate-500 dark:text-slate-400">Create, edit, and manage appeal letters and requests.</p>
                    </div>
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                                    {filteredAppeals.length > 0 ? (
                                        filteredAppeals.map((appeal) => (
                                            <tr key={appeal.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors group">
                                                <td className="px-6 py-4">
                                                    <div className="font-bold text-slate-900 dark:text-white">{appeal.title || 'Untitled Appeal'}</div>
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`text-xs font-medium px-2 py-0.5 rounded border ${
                                                        appeal.type === 'official' ? 'bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/20' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700'
                                                    }`}>
