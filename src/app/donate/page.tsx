...
export default function DonatePage() {
  ...
  return (
    <main className="bg-gray-50 dark:bg-slate-950 min-h-screen transition-colors duration-300">
      {/* Hero Section */}
      <section className="bg-white dark:bg-slate-900 py-16 lg:py-24 border-b border-gray-100 dark:border-white/5">
        <div className="container container-custom">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-7/12">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-gray-800 dark:text-white flex items-center gap-3">
              ...
              <div className="bg-yellow-50 dark:bg-yellow-500/10 border-l-4 border-yellow-400 p-6 rounded-r-lg">
                <p className="text-gray-700 dark:text-yellow-100 italic font-serif text-lg mb-2">
                  <i className="fas fa-quote-left mr-2 text-yellow-600 dark:text-yellow-500 opacity-50"></i>
                  {t('donate.verse.content')}
                </p>
                <p className="text-right text-gray-500 dark:text-yellow-200/50 font-semibold mb-0">
      ...
      <section className="py-20 lg:py-24">
        <div className="container container-custom">
          <div className="flex items-center mb-8 gap-3">
            ...
            <span className="px-3 py-1 bg-blue-100 dark:bg-blue-500/20 text-blue-800 dark:text-blue-300 rounded-full text-sm font-bold uppercase tracking-wide">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* QR Code */}
            <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-lg w-full h-full text-center flex flex-col justify-center items-center transform transition hover:-translate-y-1 hover:shadow-xl duration-300 border border-transparent dark:border-white/5 glass-panel">
               <h5 className="font-bold text-gray-500 dark:text-slate-400 mb-6 uppercase tracking-widest">{t('donate.qr.title')}</h5>
               <div className="bg-gray-50 dark:bg-white p-4 rounded-xl border border-gray-100 inline-block mb-4">
           ...
           <div className="mt-12 max-w-4xl mx-auto">
              <div className="bg-green-50 dark:bg-green-500/10 border-l-4 border-green-500 p-8 rounded-r-xl shadow-sm">
                 <div className="flex gap-4">
                    <i className="fas fa-quote-left text-4xl text-green-300 dark:text-green-600"></i>
                    <div>
                       <h5 className="font-bold text-green-700 dark:text-green-400 mb-2">{t('donate.thanks.title')}</h5>
                       <p className="text-gray-700 dark:text-green-100 italic">
      ...
      <section className="py-20 bg-gray-100 dark:bg-slate-950 border-t border-gray-200 dark:border-white/5">
         <div className="container container-custom">
            <div className="flex flex-col md:flex-row justify-between items-end md:items-center mb-10 gap-4">
               <div className="flex items-center gap-3">
                  ...
                  <span className="px-3 py-1 bg-yellow-100 dark:bg-yellow-500/20 text-yellow-800 dark:text-yellow-400 rounded-full text-sm font-bold uppercase tracking-wide">
            ...
            {appeals.length > 0 ? (
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {appeals.map((appeal) => (
                      <div key={appeal.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-white/5 overflow-hidden hover:shadow-lg transition-all group">
                         {/* Card Header */}
                         <div className="p-6 pb-4">
                            <div className="flex justify-between items-start mb-3">
                                <span className="text-xs font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">{t('donate.ministry.appeal')}</span>
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 line-clamp-2 min-h-[3.5rem]">{appeal.title}</h3>
                            <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-400 mb-4">
                                <div className="w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xs">
                                    <i className="fas fa-user"></i>
                                </div>
                                <span className="font-bold">{appeal.name}</span>
                            </div>
                            <p className="text-gray-600 dark:text-slate-400 text-sm line-clamp-3 mb-4">{appeal.content}</p>
                         </div>

                         {/* Funding Progress (Optional - simplified for now) */}
                         <div className="px-6 pb-6">
                             <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4 border border-gray-100 dark:border-white/5">
                                 <div className="flex justify-between items-end">
                                     <div className="flex-1 mr-4">
                                         <div className="mb-3">
                                            <span className="text-[10px] text-gray-400 dark:text-slate-500 uppercase font-bold tracking-widest block mb-1">Raised</span>
                                            <span className="text-lg font-extrabold text-blue-600 dark:text-blue-400 block leading-none">
                                         ...
                                         <div>
                                             <span className="text-[10px] text-gray-400 dark:text-slate-500 uppercase font-bold tracking-widest block mb-1">Target Goal</span>
                                             <span className="text-sm font-bold text-gray-900 dark:text-white block leading-none">
