...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-white py-16 mt-0 border-t border-slate-200 dark:border-white/5 relative overflow-hidden transition-colors">
        ...
        <div className="container container-custom relative z-10">
          <div className="flex flex-wrap -mx-4 mb-12">
             ...
             <div className="w-full md:w-5/12 px-4 mb-10 md:mb-0">
               <h4 className="font-bold mb-6 text-slate-900 dark:text-white flex items-center text-2xl">
                  <i className="fas fa-church me-3 text-purple-600 dark:text-purple-500"></i>
                  {t('nav.brand')}
               </h4>
               <p className="text-slate-500 dark:text-slate-400 mb-6 pr-4 leading-relaxed">
                  {t('footer.description')}
               </p>
               <div className="flex gap-4">
                  <a href="https://www.facebook.com/trieu.phanngoc.31/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/5 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-blue-600 hover:text-white hover:border-transparent transition-all transform hover:-translate-y-1 shadow-sm dark:shadow-none">
                     <i className="fab fa-facebook-f"></i>
                  </a>
                  <a href="https://www.youtube.com/@trieuphanngoc3549" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/5 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-red-600 hover:text-white hover:border-transparent transition-all transform hover:-translate-y-1 shadow-sm dark:shadow-none">
                     <i className="fab fa-youtube"></i>
                  </a>
                  <a href="https://github.com/PhanNgocTrieu" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/5 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-slate-900 dark:hover:bg-white hover:text-white dark:hover:text-slate-900 hover:border-transparent transition-all transform hover:-translate-y-1 shadow-sm dark:shadow-none">
             ...
             <div className="w-full md:w-3/12 px-4 mb-10 md:mb-0">
               <h5 className="font-bold mb-6 text-slate-900 dark:text-white text-lg">{t('footer.links_title')}</h5>
             ...
             <div className="w-full md:w-4/12 px-4">
               <h5 className="font-bold mb-6 text-slate-900 dark:text-white text-lg">{t('footer.contact_title')}</h5>
               <ul className="space-y-4 text-slate-500 dark:text-slate-400">
                  <li className="flex items-start group">
                     <div className="w-8 h-8 rounded-lg bg-white dark:bg-slate-800 flex items-center justify-center text-purple-600 dark:text-purple-500 mr-3 shrink-0 group-hover:bg-purple-600 group-hover:text-white transition-colors shadow-sm dark:shadow-none border border-slate-200 dark:border-transparent">
