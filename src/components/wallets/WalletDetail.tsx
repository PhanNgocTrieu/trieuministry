            ...
            <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                ...
                <div className="flex-1 text-center md:text-left">
                    <div className="flex items-center gap-2 justify-center md:justify-start">
                        ...
                        <span className={`px-2 py-0.5 rounded-lg text-xs font-bold uppercase ${isEstimation ? 'bg-blue-100 text-blue-700' : 'bg-blue-100 text-blue-800'}`}>
                ...
                <div className="flex gap-2">
                     {isEstimation && (
                        <button 
                            ...
                            className="px-4 py-2 bg-blue-700 text-white rounded-xl font-bold hover:bg-blue-600 shadow-sm"
                        >
