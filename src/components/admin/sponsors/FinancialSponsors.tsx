    ...
    return (
        <div className="space-y-8 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-xl font-bold text-slate-900 dark:text-white">Financial Commitments</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Track monthly and yearly financial support.</p>
                </div>
                <button
